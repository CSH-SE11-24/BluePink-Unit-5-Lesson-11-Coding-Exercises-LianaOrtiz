...
let sun = document.querySelector("#lightMode")
...
sun.addEventListener("click", function(event){
  bodyy.style.backgroundColor = "lightyellow"
  bodyy.style.color = "navy"
})
...
moon.addEventListener("click", function(event){
  bodyy.style.backgroundColor = "navy"
  bodyy.style.color = "lightyellow"
})
